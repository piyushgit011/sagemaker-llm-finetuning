...
The problem with small models is that they don’t have multilingual support. These models can answer only english languages perfectly, as the different languages like hindi ,etc takes more token to generate a single token.they have low accuracy with multilingual languages.
